          ...
          {selectedAnnuncio ? (
            <div className="annuncio-detail">
              <div className="annuncio-detail-header">
                ...
                <div className="annuncio-detail-meta">
                ...
                </div>                <div className="annuncio-actions">                  <button 
                    className={`icon-button toggle-button ${selectedAnnuncio.stato === 'nascosto' ? 'show' : 'hide'}`}
                    onClick={() => {
                      console.log("Debug Toggle - selectedAnnuncio:", {
                        ...
                        // USA documentId come nel tuo script funzionante
                  ...
                  >
                    {selectedAnnuncio.stato === 'nascosto' ? <FaEye /> : <FaEyeSlash />}
                    <span className="button-text">{selectedAnnuncio.stato === 'nascosto' ? 'Pubblica' : 'Nascondi'}</span>
                  </button>
                  ...
                  >
                    <FaPencilAlt />
                    <span className="button-text">Modifica</span>
                  </button>
                    <button 
